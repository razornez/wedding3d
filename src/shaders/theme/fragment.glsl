...
uniform sampler2D uDayTexture5;
uniform sampler2D uNightTexture5;
...
void main() {
    ...
    } else if(uTextureSet == 4) {
        dayColor = texture2D(uDayTexture4, vUv).rgb;
        nightColor = texture2D(uNightTexture4, vUv).rgb;
    } else {
        dayColor = texture2D(uDayTexture5, vUv).rgb;
        nightColor = texture2D(uNightTexture5, vUv).rgb;
    }
